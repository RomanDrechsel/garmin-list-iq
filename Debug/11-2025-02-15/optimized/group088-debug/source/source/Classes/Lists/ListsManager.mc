...
module Lists {
    ...
    class ListsManager {
        ...
        function addList(data as Dictionary) as Boolean {
            var pre__data_, list, itemsArr, itemKeys, save, pre__name_, pre__order_, pre_0, pre_1, pre_4, pre_5;
            pre_0 = 0;
            var keys = data.keys();
            var listuuid = null;
            var listname = null;
            ...
            {
                itemsArr /*>i<*/ = pre_0;
                for (; itemsArr /*>i<*/ < keys.size(); itemsArr /*>i<*/ += pre_1) {
                    save /*>key<*/ = keys[itemsArr /*>i<*/];
                    pre__data_ /*>val<*/ = data.get(save /*>key<*/);
                    if (save /*>key<*/.equals("uuid")) {
                        listuuid = pre__data_ /*>val<*/.toString();
                    } else if (save /*>key<*/.equals(pre__name_)) {
                        listname = pre__data_ /*>val<*/.toString();
                    } else if (save /*>key<*/.equals(pre__order_)) {
                        listorder = pre__data_ /*>val<*/.toNumber();
                    } else if (save /*>key<*/.equals("date")) {
                        listdate = pre__data_ /*>val<*/.toLong();
                        if (listdate != null) {
                        ...
                        list /*>index<*/ = save /*>key<*/.substring(pre_4, pre_5).toNumber();
                        save /*>split<*/ = Helper.StringUtil.split(save /*>key<*/.substring(pre_5, save /*>key<*/.length()), "_", 2);
                        itemKeys /*>prop<*/ = save /*>split<*/.size() > pre_1 ? save /*>split<*/[pre_1] : null;
                        if (itemKeys /*>prop<*/ != null) {
                            if (listitems.hasKey(list /*>index<*/)) {
                                save /*>item<*/ = listitems.get(list /*>index<*/);
                            } else {
                                save /*>item<*/ = { "d" => false };
                            }
                            if (itemKeys /*>prop<*/.equals("item")) {
                                save /*>item<*/.put("i", pre__data_ /*>val<*/.toString());
                            } else if (itemKeys /*>prop<*/.equals("note")) {
                                save /*>item<*/.put("n", pre__data_ /*>val<*/.toString());
                            }
                            listitems.put(list /*>index<*/, save /*>item<*/);
                        }
                    } else if (save /*>key<*/.substring(pre_0, pre_5).equals("reset")) {
                        if (save /*>key<*/.equals("reset_active")) {
                            pre__data_ /*>val<*/ = Helper.StringUtil.StringToBool(pre__data_ /*>val<*/);
                            if (pre__data_ /*>val<*/ != null) {
                                reset = pre__data_ /*>val<*/;
                            }
                        } else if (save /*>key<*/.equals("reset_interval")) {
                            reset_interval = pre__data_ /*>val<*/.toString(); //no reference
                        } else if (save /*>key<*/.equals("reset_hour")) {
                            pre__data_ /*>val<*/ = pre__data_ /*>val<*/.toNumber();
                            if (pre__data_ /*>val<*/ != null) {
                                reset_hour = pre__data_ /*>val<*/;
                            }
                        } else if (save /*>key<*/.equals("reset_minute")) {
                            pre__data_ /*>val<*/ = pre__data_ /*>val<*/.toNumber();
                            if (pre__data_ /*>val<*/ != null) {
                                reset_minute = pre__data_ /*>val<*/;
                            }
                        } else if (save /*>key<*/.equals("reset_weekday")) {
                            pre__data_ /*>val<*/ = pre__data_ /*>val<*/.toNumber();
                            if (pre__data_ /*>val<*/ != null) {
                                reset_weekday = pre__data_ /*>val<*/;
                            }
                        } else if (save /*>key<*/.equals("reset_day")) {
                            pre__data_ /*>val<*/ = pre__data_ /*>val<*/.toNumber();
                            if (pre__data_ /*>val<*/ != null) {
                                reset_day = pre__data_ /*>val<*/;
                            }
                        }
                    }
                }
            ...
            itemsArr = [];
            if (listitems.size() > pre_0) {
                itemKeys = Helper.Quicksort.Sort(listitems.keys());
                {
                    save /*>i<*/ = pre_0;
                    for (; save /*>i<*/ < itemKeys.size(); save /*>i<*/ += pre_1) {
                        itemsArr.add(listitems.get(itemKeys[save /*>i<*/]));
                    }
                }
            }
