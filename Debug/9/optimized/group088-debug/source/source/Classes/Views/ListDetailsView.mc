            ...
            if (self._listUuid == null || $.getApp().ListsManager == null) {
                ...
                if (list == null) {
                    ...
                    if (list.hasKey(pre__items_)) {
                        ...
                        {
                            item_0 /*>i<*/ = pre_0;
                            for (; item_0 /*>i<*/ < list[pre__items_].size(); item_0 /*>i<*/ += pre_1) {
                                count += pre_1;
                                item_1 /*>item<*/ = list[pre__items_][item_0 /*>i<*/];
                                item_1 /*>item<*/.put("pos", item_0 /*>i<*/);
                                if ((move_down == true || move_down == pre_1) && item_1 /*>item<*/.get(pre__d_) == true) {
                                    done.add(item_1 /*>item<*/);
                                } else {
                                    ordered.add(item_1 /*>item<*/);
                                }
                            }
                        }
...

                        {
                            ...
                            for (; move_down /*>i<*/ < ordered.size(); move_down /*>i<*/ += pre_1) {
                                pre__items_ /*>item<*/ = ordered[move_down /*>i<*/];
                                var iconInvert, obj;

                                if (pre__items_ /*>item<*/.hasKey(pre__d_) && pre__items_ /*>item<*/.get(pre__d_) == true) {
                                    done /*>icon<*/ = self._itemIconDone;
                                    iconInvert = self._itemIconDoneInvert;
                                    obj = true;
                                } else {
                                    done /*>icon<*/ = self._itemIcon;
                                    iconInvert = self._itemIconInvert;
                                    obj = false;
                                }

                                item_1 /*>text<*/ = pre__items_ /*>item<*/.get("i");
                                item_0 /*>note<*/ = show_notes == true ? pre__items_ /*>item<*/.get("n") : null;

                                if (item_1 /*>text<*/ != null) {
                                    item_0 /*>itemObj<*/ = self.addItem(item_1 /*>text<*/, item_0 /*>note<*/, obj, done /*>icon<*/, pre__items_ /*>item<*/.get("pos"));
                                    item_0 /*>itemObj<*/.setIconInvert(iconInvert);
                                    item_0 /*>itemObj<*/.isDisabled = obj;
                                }
                            }
                        }

                        if (count <= pre_0) {
                            item_0 /*>item<*/ = new Listitems.Item(self._mainLayer, null, Application.loadResource(Rez.Strings.ListEmpty), null, null, null, pre_0, null);
                            item_0 /*>item<*/.SubtitleJustification = pre_1 as Toybox.Graphics.TextJustification;
                            item_0 /*>item<*/.isSelectable = false;
                            item_0 /*>item<*/.DrawLine = false;
                            self.Items.add(item_0 /*>item<*/);
                        }
