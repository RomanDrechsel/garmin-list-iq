...
module Helper 
{
    class DateUtil
    {
        static function toString(timestamp as Number, date_separator as String?) as String
        {
            ...
            var greg = Gregorian.info(moment, Gregorian.FORMAT_SHORT);
            var greg_long = Gregorian.info(moment, Gregorian.FORMAT_LONG);
            var greg_now = Gregorian.info(Time.now(), Gregorian.FORMAT_SHORT);
